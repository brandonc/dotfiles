...
1. fix npm audit[high]: [Remote Code Execution](https://github.com/Microsoft/vscode-python/blob/HEAD/npmjs.com/advisories/1548)
...
-   Improved error handling when loading [Jupyter/IPython](https://github.com/Microsoft/vscode-python/blob/HEAD/<https://github.com/DonJayamanne/pythonVSCode/wiki/Jupyter-(IPython)>)
-   Fixes to unittests

## Version 0.4.0

-   Added support for [Jupyter/IPython](https://github.com/Microsoft/vscode-python/blob/HEAD/<https://github.com/DonJayamanne/pythonVSCode/wiki/Jupyter-(IPython)>)
